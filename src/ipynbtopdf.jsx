...
const IpynbToPdf = () => {
  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      if (file.name.endsWith('.ipynb')) {
        ...
        setErrorMessage('Please upload a valid .ipynb file');
        setSelectedFile(null);
        setFileName('');
      }
    }
  ...
  return (
    <div style={mainContainer}>
      <header style={header}>
        <h1 style={headerTitle}>Jupyter Notebook to PDF</h1>
        <p style={headerSubtitle}>
          Convert your .ipynb files to PDF with one click
        </p>
      </header>
          ...
          <div style={uploadContainer}>
            <div style={uploadContent}>
              ...
              {fileName ? (
                ...
                <p style={uploadText}>Drag & drop your .ipynb file here</p>
              )}
              ...
              <p style={fileTypeHint}>.ipynb files only (max 10MB)</p>
              ...
              <div style={emptyPreview}>
                ...
                <p style={emptyHint}>
                  {selectedFile
                    ...
                    : 'Upload a Jupyter Notebook to begin'}
                </p>
              </div>
            </div>
          </div>
