...
const ExcelToPdf = () => {
  ...
  return (
    <div style={mainContainer}>
      <header style={header}>
        <h1 style={headerTitle}>Excel to PDF Converter</h1>
        <p style={headerSubtitle}>
          Convert your Excel spreadsheets to PDF with one click
        </p>
      </header>
          ...
          <div style={uploadContainer}>
            <div style={uploadContent}>
              ...
              {fileName ? (
                ...
                <p style={uploadText}>Drag & drop your Excel file here</p>
              )}
              ...
              <p style={fileTypeHint}>.xlsx or .xls files only (max 10MB)</p>
