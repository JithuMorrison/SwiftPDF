...
const WordToPdf = () => {
  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      if (file.type === 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' || 
        ...
        setErrorMessage('Please upload a valid .docx or .doc file');
        setSelectedFile(null);
        setFileName('');
      }
    }
  ...
  const handleUpload = async () => {
    ...
    try {
      let response = await fetch('http://localhost:5001/convert/word-to-pdf', {
        method: 'POST',
        body: formData,
      });

      if (!response.ok) {
        response = await fetch('https://trauma-chi.vercel.app/convert/word-to-pdf', {
          method: 'POST',
          body: formData,
        });
      }
  ...
  return (
    <div style={mainContainer}>
      <header style={header}>
        <h1 style={headerTitle}>Word to PDF Converter</h1>
        <p style={headerSubtitle}>
          Convert your Word documents to PDF with one click
        </p>
      </header>
          ...
          <div style={uploadContainer}>
            <div style={uploadContent}>
              ...
              {fileName ? (
                ...
                <p style={uploadText}>Drag & drop your Word file here</p>
              )}
              ...
              <p style={fileTypeHint}>.docx or .doc files only (max 10MB)</p>
              ...
              <div style={emptyPreview}>
                ...
                <p style={emptyHint}>
                  {selectedFile
                    ...
                    : 'Upload a Word document to begin'}
                </p>
              </div>
            </div>
          </div>
